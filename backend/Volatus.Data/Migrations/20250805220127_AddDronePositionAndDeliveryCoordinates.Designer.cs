...
namespace Volatus.Data.Migrations
{
    ...
    [Migration("20250805220127_AddDronePositionAndDeliveryCoordinates")]
    partial class AddDronePositionAndDeliveryCoordinates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volatus.Domain.Entities.Delivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Volatus.Domain.Entities.Drone", b =>
                {
                    ...
                    b.Property<double>("CurrentX")
                        .HasColumnType("double precision");

                    b.Property<double>("CurrentY")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Volatus.Domain.Entities.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Volatus.Domain.Entities.Delivery", b =>
                {
                    b.HasOne("Volatus.Domain.Entities.Drone", "Drone")
                        .WithMany()
