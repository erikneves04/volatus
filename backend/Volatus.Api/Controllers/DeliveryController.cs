...
public class DeliveryController : Controller
{
    ...
    [HttpGet]
    public ActionResult<Response<IEnumerable<DeliveryViewModel>>> Get([FromQuery] PaginationParams @params)
    {
    ...
    [HttpGet("{id}")]
    public ActionResult<Response<DeliveryViewModel>> Get(Guid id)
    {
    ...
    [HttpPost]
    public ActionResult<Response<DeliveryViewModel>> Post([FromBody] DeliveryInsertViewModel model)
    {
    ...
    [HttpPut("{id}")]
    public ActionResult<Response<DeliveryViewModel>> Put([FromBody] DeliveryUpdateViewModel model, Guid id)
    {
    ...
    public ActionResult<Response<DeliveryViewModel>> AssignDrone([FromBody] DeliveryAssignmentViewModel model)
    {
        var content = _services.AssignDrone(model);
        return BuildResponse(content);
    }
} 